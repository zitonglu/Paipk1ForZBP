...
{/if}
            ...
            <p>Powered By <a href="{$zblogphpabbrhtml}" target="_blank">Z-BlogPHP.</a> Theme by <a href="http://www.paipk.com" title="拍拍看科技-专业z-blogPHP主题模版制作" target="_blank" >Paipk.com.</a></p>
            {if $zbp->Config('paipk1')->baike!=""}<p>{$zbp->Config('paipk1')->baike}</p>{/if}
            <p>{$copyright}</p>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="http://api.qrserver.com/v1/create-qr-code/?size=2560x256&amp;data={$article.Url}" class="img-responsive center-block" alt="文章网址的二维码">
