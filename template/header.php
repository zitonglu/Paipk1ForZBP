...
{/if}
 	<link rel="stylesheet" href="{$host}zb_users/theme/{$theme}/style/style.css?v=2.3" type="text/css">
  <link rel="stylesheet" href="{$host}zb_users/theme/{$theme}/style/color.css?v=2.3" type="text/css">
